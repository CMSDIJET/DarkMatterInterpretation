...
def main():
	...
	fin2 = ROOT.TFile("limits_freq_qq_calodijet2016_pfdijet2016_129.root");
        ...
        fin3 = ROOT.TFile("limits_freq_qq_calodijet2016.root");
	...
	obslo  = fin3.Get("obs_qq_calodijet2016");
	explo1 = fin3.Get("exp1sigma_qq_calodijet2016");
	explo2 = fin3.Get("exp2sigma_qq_calodijet2016");
	...
	txta = ROOT.TLatex(0.22,0.88,"CMS Preliminary"); txta.SetNDC();
	...
	leg.AddEntry(obs_gq,"Observed_36^-1","l")
	...
	can_gB = ROOT.TCanvas("can_gB","can_gB",900,800);
        can_gB.Divide(1)
	can_gB.SetPad(0.0,0.0,1.0,1.0)
	can_gB.cd(1).SetLeftMargin(0.15)
	can_gB.cd(1).SetRightMargin(0.05)
