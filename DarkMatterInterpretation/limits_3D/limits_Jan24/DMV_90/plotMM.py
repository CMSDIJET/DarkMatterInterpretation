...
elif DijetOnly: leg=C.BuildLegend(0.72,0.13,0.89,0.34)
...
leg.SetFillStyle(0)
leg.Clear()
if DijetOnly: leg.SetHeader("Dijet 90% CL")
...
if Mediator=="Vector" and DijetOnly:
    leg1=TLatex(1500,500,"#splitline{#bf{"+Mediator+" mediator}}{#bf{Dirac DM}}")
    leg4=TLatex(1500,400,"#it{g_{q} = 0.25, g_{DM} = 1}")
    leg4.SetTextFont(42)
    leg4.SetTextSize(0.030)
    leg4.Draw("same")
elif Mediator=="Axial" and DijetOnly:
    leg1=TLatex(1500,300,"#splitline{#bf{"+Mediator+"-vector mediator}}{#bf{Dirac DM}}")
    leg4=TLatex(1500,200,"#it{g_{q} = 0.25, g_{DM} = 1}")
    leg4.SetTextFont(42)
    leg4.SetTextSize(0.030)
    leg4.Draw("same")
elif Mediator=="Vector" and not METXonly:
...
if DijetOnly : 
    ...
    # lumi
    leg3=TLatex(2800,1720,"35.9 fb^{-1} (13 TeV)")
    leg3.SetTextFont(42)
