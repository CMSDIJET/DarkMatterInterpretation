...
def main():
	...
	# read in the data: 
	fin1 = ROOT.TFile("limits_freq_qq_calodijet2016.root");
        fin2 = ROOT.TFile("limits_freq_gg_qg_qq_pfdijet2016_95CL_moriondDataset_JECV1_35900pb.root");

	obslo  = fin1.Get("obs_qq_calodijet2016");
	explo1 = fin1.Get("exp1sigma_qq_calodijet2016");
	explo2 = fin1.Get("exp2sigma_qq_calodijet2016");

	obshi  = fin2.Get("obs_qq_pfdijet2016");
	exphi1 = fin2.Get("exp1sigma_qq_pfdijet2016");
	exphi2 = fin2.Get("exp2sigma_qq_pfdijet2016");
	...
	txtc = ROOT.TLatex(0.73,0.92,"27 fb^{-1} & 36 fb^{-1} (13 TeV)");
